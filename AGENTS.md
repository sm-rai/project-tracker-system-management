...
- **PRD**: The Product Requirements Document for this project is located at `docs/PRD.md`. Always refer to this document to understand the scope, data model, business logic, and functional features before making significant changes (new features, migrations, or business logic).
